# 去除浅色水印，效果请参见 https://gitee.com/xie2021/batch-de-light-watermark
...
#修改input和output路径，即可运行
def main():
    print(u'自动去水印！')
    input_dir = "C:/Users/Seafile/My Library/"
    output_dir = "C:/Users//Seafile/My Library/output/"
